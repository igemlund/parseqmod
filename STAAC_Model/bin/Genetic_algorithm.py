...
def GA(mutationFrequency = 0.1, popsize=50, nGenerations=5, nParents=0.3, n_splitsCrossover=2):
    timer = time()
...
if __name__ == '__main__':
    GA_df = GA(nGenerations=100, mutationFrequency=0.1, popsize=50, n_splitsCrossover=2)
    print(GA_df)
